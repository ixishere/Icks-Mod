...
public class EntityTameDragon extends EntityLiving implements IEntityMultiPart, IMob
{
    private static final Logger LOGGER = LogManager.getLogger();
    public static final DataParameter<Integer> PHASE = EntityDataManager.<Integer>createKey(EntityTameDragon.class, DataSerializers.VARINT);
    ...
    public EntityTameDragon(World worldIn)
    {
        super(worldIn);
    ...
    public boolean startRiding(Entity entityIn) {
    	...
    	entityIn.rotationPitch = rotationPitch;
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityTameDragon.class);
    }
